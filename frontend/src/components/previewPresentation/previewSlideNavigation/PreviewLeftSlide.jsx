...
function PreviewLeftSlide ({ setChangeSlide, currentSlideNumInt, presentation }) {
  ...
  return (
    <div onClick={handleLeftSlideClick} id='preview-left-slide' className='slide-presentation-arrow-button dark-background-colour-theme' title="Go to left slide">
...
export default PreviewLeftSlide;
