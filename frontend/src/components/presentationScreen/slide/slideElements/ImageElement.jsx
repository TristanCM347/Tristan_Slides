...
function ImageElement ({ content, setOptionsModalState, setPresentation, width, height, currentSlideNumInt, presentation, selectedElementID, setSelectedElementID }) {
  ...
  return (
    <Rnd
      ...
      onDoubleClick={isSelected ? handleEditImage : null}
