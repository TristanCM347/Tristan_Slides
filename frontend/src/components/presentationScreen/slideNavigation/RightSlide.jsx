...
function RightSlide ({ currentSlideNumInt }) {
  ...
  return (
    <div onClick={handleRightSlideClick} id='right-slide' className='slide-presentation-arrow-button dark-background-colour-theme' title="Go to right slide" >
