let fs,jwt,AsyncLock,InputError,AccessError;_bee‍.x([["save",()=>save],["reset",()=>reset],["userLock",()=>userLock],["getEmailFromAuthorization",()=>getEmailFromAuthorization],["login",()=>login],["logout",()=>logout],["register",()=>register],["getStore",()=>getStore],["setStore",()=>setStore]]);_bee‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_bee‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_bee‍.w("async-lock",[["default",["AsyncLock"],function(v){AsyncLock=v}]]);_bee‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);
